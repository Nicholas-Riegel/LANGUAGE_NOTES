...
int main() {
	...
	cout << "First car: " << cars.at(0) << endl; // Volvo
    ...
    cout << "Added Tesla and VW. Last car: " << cars.back() << endl; // VW
		// push_back does NOT return the element added; it just adds to the end

		// pop_back does NOT return the element removed; it just removes the last element
		// If you want the value, get it first:
		string removed = cars.back();
    cars.pop_back();
		cout << "Removed element: " << removed << endl; // VW
